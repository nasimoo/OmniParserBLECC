...
def Wash(hid,bbox_utils):
    ...
    time.sleep(5)
    bbox_utils.bbox_click("58", CSV_FILE_PATH, hid, x_offset=-50)  # Open Chrome
    time.sleep(5)
    hid.refresh_page()
    ...
    bbox_utils.bbox_click("49", CSV_FILE_PATH_2, hid,y_offset=70, x_offset=-10)  # click more options
    bbox_utils.bbox_click("49", CSV_FILE_PATH_2, hid,y_offset=70, x_offset=-30)  # delete
